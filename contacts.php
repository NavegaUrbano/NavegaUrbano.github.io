  ...
  <body>
    ...
    <!-- Page-->
      ...
      <header class="section page-header breadcrumbs-custom-wrap bg-gradient bg-secondary-2 novi-background bg-cover">
          ...
          <nav class="rd-navbar" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-fullwidth" data-xl-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-fixed" data-xl-device-layout="rd-navbar-static" data-md-stick-up-offset="2px" data-lg-stick-up-offset="2px" data-stick-up="true" data-sm-stick-up="true" data-md-stick-up="true" data-lg-stick-up="true" data-xl-stick-up="true">
            <div class="rd-navbar-inner"> 
              ...
              <div class="rd-navbar-panel">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand"><a class="brand-name" href="index.php"><img class="logo-default" src="images/Logo_nav1.jpg" alt="" width="208" height="46"/><img class="logo-inverse" src="images/Logo_nav1.jpg" alt="" width="208" height="46"/></a></div>
              </div>
              <div class="rd-navbar-aside-right">
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li><a href="about-us.php">Acerca de Nosotros</a>
                    </li>
                    <li class="active"><a href="contacts.php">Contactanos</a>
                    </li>
        ...
        <!-- Breadcrumbs-->
        <section class="breadcrumbs-custom" style="background: url(&quot;images/contact.jpg&quot;); background-size: cover;">
          <div class="container">
            <p class="breadcrumbs-custom-subtitle">Asistencia a un click de distancia</p>
            <p class="heading-1 breadcrumbs-custom-title">Contactanos</p>
          ...
          <div class="row row-fix row-50 row-custom-bordered">
            <div class="col-sm-6 col-lg-3">
              ...
              <article class="box-simple">
                ...
                <h6>Direccion</h6>
                <div class="box-simple-text"><a href="#">Carr. Federal Pachuca - Mexico, 55749 San Martín Azcatepec, Méx.</a></div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-3">
              <!-- Box simple-->
              <article class="box-simple">
                ...
                <div class="box-simple-text">
                  <ul class="list-comma list-0">
                    <li><a href="tel:#">+52 557 131 3133</a></li>
                    <li><a href="tel:#">+52 132 465 7987</a></li>
                  </ul>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-3">
              ...
              <article class="box-simple">
                ...
                <div class="box-simple-text">
                  <ul class="list-comma list-0">
                    <li><a href="mailto:#">navegaurbano@navegaurbano.org</a></li>
                  </ul>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-3">
              ...
              <article class="box-simple">
                ...
                <div class="box-simple-text">
                  <ul class="list-0">
                    <li>Lunes–Viernes: 9:00 am–4:00 pm</li>
                    <li>Sabados–Domingos: 11:00 am–2:00 pm</li>
                  </ul>
                </div>
              </article>
            </div>
      ...
      <section class="section section-wrap bg-gray-lighter novi-background bg-cover">
        <div class="section-wrap-inner">
            ...
            <div class="row row-fix row-50">
              <div class="col-lg-8 col-xl-7">
                <div class="section-wrap-content section-lg">
                  ...
                  <p class="big">Usted puede enviarnos sus comentarios o sugerencias para que NavegaUrbano siga creciendo, si tiene alguna duda acerca de contactarnos tambien puede llenar los siguientes campos, y el equipo de Movilidad360 se pondra en contacto con ustd tan pronto como sea posible</p>
                  <!-- RD Mailform-->
                  <form class="rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                    <div class="row row-fix row-20">
                      ...
                      <div class="col-md-6">
                        <div class="form-wrap form-wrap-validation">
                          <label class="form-label-outside" for="form-1-last-name">Apellido</label>
                      ...
                      <div class="col-md-6">
                        <div class="form-wrap form-wrap-validation">
                          <label class="form-label-outside" for="form-1-phone">Telefono</label>
                          <input class="form-input" id="form-1-phone" type="text" name="phone" data-constraints="@Numeric @Required"/>
                        </div>
                      </div>
                      <div class="col-sm-12">
                        <div class="form-wrap form-wrap-validation">
                          <label class="form-label-outside" for="form-1-message">Escribe tu comentario</label>
                      ...
                      <div class="col-sm-12 offset-custom-1">
                        <div class="form-button">
                          <button class="button button-secondary button-nina" type="submit">Enviar comentario</button>
                        </div>
                      </div>
                    </div>
                  </form>
          ...
          <!--<div class="section-wrap-aside">
            < RD Google Map-->
            <!--<div class="google-map-container google-map-with-icon rd-google-map__model" data-zoom="5" data-center="Carr. Federal Pachuca - Mexico, 55749 San Martín Azcatepec, Méx." data-icon="images/gmap_marker.png" data-icon-active="images/gmap_marker_active.png" data-styles="[{&quot;featureType&quot;:&quot;landscape&quot;,&quot;stylers&quot;:[{&quot;saturation&quot;:-100},{&quot;lightness&quot;:60}]},{&quot;featureType&quot;:&quot;road.local&quot;,&quot;stylers&quot;:[{&quot;saturation&quot;:-100},{&quot;lightness&quot;:40},{&quot;visibility&quot;:&quot;on&quot;}]},{&quot;featureType&quot;:&quot;transit&quot;,&quot;stylers&quot;:[{&quot;saturation&quot;:-100},{&quot;visibility&quot;:&quot;simplified&quot;}]},{&quot;featureType&quot;:&quot;administrative.province&quot;,&quot;stylers&quot;:[{&quot;visibility&quot;:&quot;off&quot;}]},{&quot;featureType&quot;:&quot;water&quot;,&quot;stylers&quot;:[{&quot;visibility&quot;:&quot;on&quot;},{&quot;lightness&quot;:30}]},{&quot;featureType&quot;:&quot;road.highway&quot;,&quot;elementType&quot;:&quot;geometry.fill&quot;,&quot;stylers&quot;:[{&quot;color&quot;:&quot;#ef8c25&quot;},{&quot;lightness&quot;:40}]},{&quot;featureType&quot;:&quot;road.highway&quot;,&quot;elementType&quot;:&quot;geometry.stroke&quot;,&quot;stylers&quot;:[{&quot;visibility&quot;:&quot;off&quot;}]},{&quot;featureType&quot;:&quot;poi.park&quot;,&quot;elementType&quot;:&quot;geometry.fill&quot;,&quot;stylers&quot;:[{&quot;color&quot;:&quot;#b6c54c&quot;},{&quot;lightness&quot;:40},{&quot;saturation&quot;:-40}]},{}]">
              <div class="google-map"></div>
              <ul class="google-map-markers">
                <li data-location="Carr. Federal Pachuca - Mexico, 55749 San Martín Azcatepec, Méx." data-description="Carr. Federal Pachuca - Mexico, 55749 San Martín Azcatepec, Méx."></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <footer class="section page-footer page-footer-minimal novi-background bg-cover text-center bg-gray-darker">
        <div class="container container-wide">
          <div class="row row-fix justify-content-sm-center align-items-md-center row-30">
            <div class="col-md-10 col-lg-7 col-xl-4 text-xl-left"><a href="index.html"><img class="inverse-logo" src="images/Logo_nav1.jpg" alt="" width="208" height="46"/></a></div>
            <div class="col-md-10 col-lg-7 col-xl-4">
              <p class="right">&#169;&nbsp;<span class="copyright-year"></span> Todos los derechos resrvados.</p>
            </div>
